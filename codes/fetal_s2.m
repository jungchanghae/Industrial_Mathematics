...
for i = 1 : t1
   ...
   S2_temp = S2(i); S3_temp = S3(i);
    ...
    while ok ~= 6
        ...
        A(3,1) = 0;
        A(3,2) = -dt/R3;
        A(3,3) = C3 + dt * (1/R3 + 1/R4 + 1/R10 +1/R15);
        A(3,4) = -dt/R4;
        A(3,5) = -dt/R10;
        A(3,6) = 0;
        A(3,7) = 0;
        ...
        A(5,3) = -dt/R10;
        A(5,4) = 0;
        A(5,5) = C5(i+1) + dt * (S3_temp/R5 + 1/R9 + 1/R10);
        A(5,6) = -S3_temp * dt/R5;
        A(5,7) = 0;
        A(5,8) = -dt/R9;
        A(5,9) = 0;
        ...
        A(10,8) = 0;
        A(10,9) = -dt/R13;
        A(10,10) = C10 + dt * (1/R13 + 1/R14 + 1/R1);
        A(10,11) = -dt/R14;
        ...
        if S2_temp == S2(i+1) && S3_temp == S3(i+1)
            ok = 6;
        else
            if ok == 1
                S2_temp = 0; S3_temp = 0;
